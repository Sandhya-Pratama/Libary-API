...
const (
	AuthorService_GetAllAuthors_FullMethodName = "/author.AuthorService/GetAllAuthors"
...
type AuthorServiceClient interface {
	...
	GetAllAuthors(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AuthorListResponse, error)
...
func (c *authorServiceClient) GetAllAuthors(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AuthorListResponse, error) {
...
type AuthorServiceServer interface {
	// Mendapatkan semua penulis
	GetAllAuthors(context.Context, *Empty) (*AuthorListResponse, error)
	// Membuat penulis baru
...
func (UnimplementedAuthorServiceServer) GetAllAuthors(context.Context, *Empty) (*AuthorListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllAuthors not implemented")
}
func (UnimplementedAuthorServiceServer) CreateAuthor(context.Context, *AuthorRequest) (*AuthorResponse, error) {
...
var AuthorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "common/proto/author.proto",
}
